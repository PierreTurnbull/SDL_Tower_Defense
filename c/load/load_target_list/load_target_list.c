void  load_target_list(struct s_game *game)
{
  ...
  game->play.target_list.target_tex[0]        = IMG_LoadTexture(game->rend, "img/play/target/target1.png");
  game->play.target_list.target_tex[1]        = IMG_LoadTexture(game->rend, "img/play/target/target2.png");
  game->play.target_list.target_tex[2]        = IMG_LoadTexture(game->rend, "img/play/target/target3.png");
